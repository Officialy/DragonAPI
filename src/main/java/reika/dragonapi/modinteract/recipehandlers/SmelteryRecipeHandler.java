...
//		Block b = Block.byItem(render.getItem());
//		if (!(render.getItem() instanceof BlockItem) || b == Blocks.AIR)
//			throw new MisuseException("The render block must be a non-null block!");
//		if (!isLoaded)
//			return;
//		try {
//			addMelting.invoke(smelteryInstance, is, b, temp, fluid);
//			DragonAPI.LOGGER.info("Adding smeltery melting of "+is+" into "+fluidToString(fluid)+".");
//		}
//		catch (Exception e) {
//			DragonAPI.LOGGER.error("Could not add Smeltery Recipe for "+is+" to "+fluidToString(fluid)+" @ "+temp+"!");
//			e.printStackTrace();
//		}
//	}
//
...
//			DragonAPI.LOGGER.info("Adding casting of "+fluidToString(in)+" to "+out+" with "+cast+".");
//		}
//		catch (Exception e) {
//			DragonAPI.LOGGER.error("Could not add Casting Recipe for "+fluidToString(in)+" to "+out+" with "+cast+"!");
//			e.printStackTrace();
//		}
//	}
//
...
//		if (!(block.getItem() instanceof BlockItem))
...
//			DragonAPI.LOGGER.info("Adding block casting of "+fluidToString(fluid)+" to "+block+".");
//		}
//		catch (Exception e) {
//			DragonAPI.LOGGER.error("Could not add Block Casting Recipe for "+fluidToString(fluid)+" to "+block+"!");
//			e.printStackTrace();
//		}
//	}
//
...
//			DragonAPI.LOGGER.info("Adding alloying of "+Arrays.toString(in)+" to "+fluidToString(out)+".");
//		}
//		catch (Exception e) {
//			DragonAPI.LOGGER.error("Could not add alloying of "+Arrays.toString(in)+" to "+fluidToString(out)+".");
//			e.printStackTrace();
//		}
//	}
//
...
//		}
//		catch (Exception e) {
//			DragonAPI.LOGGER.error("Could not fetch TiC Casting Recipes!");
//			e.printStackTrace();
//			return null;
//		}
//	}
...
//		}
//		catch (Exception e) {
//			DragonAPI.LOGGER.error("Could not fetch TiC Casting Recipe output!");
//			e.printStackTrace();
//			return null;
//		}
//	}
...
//		}
//		catch (Exception e) {
//			DragonAPI.LOGGER.error("Could not fetch TiC Casting Recipe fluid!");
//			e.printStackTrace();
//			return null;
//		}
//	}
...
//		}
//		catch (Exception e) {
//			DragonAPI.LOGGER.error("Could not fetch TiC Casting Recipe cast!");
//			e.printStackTrace();
//			return null;
//		}
//	}
...
//		return fs.getAmount()+" mB of "+fs.getLocalizedName();
//	}
//
...
//			}
//			catch (Exception e) {
//				DragonAPI.LOGGER.error("Could not load Smeltery Recipe Handler!");
//				e.printStackTrace();
